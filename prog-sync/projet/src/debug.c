...
void Debug__dbg_color_step(float r, float g, float b, Debug__dbg_color_out *o) {
  log_info("rgb: (%f, %f, %f)\n", r, g, b);
}

void Debug__dbg_float_to_float_step(char* msg, float left, float right, Debug__dbg_float_to_float_out *o) {
  log_info("%s %f -> %f\n", msg, left, right);
}
