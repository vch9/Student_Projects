...
(** PREUVES FACULTATIVES POUR LE PROJET *)
...
Instance mk_sim : Proper (eqlist ==> sim) mk.
Proof.
...
Proof.
 ...
 - subst l'. simpl. destruct l; try easy. intros ->; intuition.
 - apply IHSorted; intuition.
...
Proof.
 ...
 rewrite merge_eqlist, in_app_iff; intuition.
Qed.
...
Proof.
 ...
 - rewrite merge_eqlist at 1; rewrite in_app_iff.
...
Instance : Proper (sim ==> eq) is_nullable.
Proof.
 intros r1 r2 Hr.
Admitted.

Instance : Proper (sim ==> eq ==> sim) deriv1.
Proof.
 intros r r' Hr a a' <-.
Admitted.
...
Instance : Proper (sim ==> eq ==> sim) deriv.
Proof.
 intros r r' Hr w w' <-.
Admitted.

Instance : Proper (sim ==> eq ==> eq) matching.
Proof.
 intros r r' Hr w w' <-.
Admitted.
